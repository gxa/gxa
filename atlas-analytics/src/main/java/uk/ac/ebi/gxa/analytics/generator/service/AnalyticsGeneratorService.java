 ...
 * <p/>
 * All implementing classes should implement the method {@link #createAnalytics()} ()} ()} which contains the logic for
 * constructing the relevant parts of the index for each implementation.  Clients should call {@link
 * #generateAnalytics()} ()} to trigger Analytics construction.  At the moment, this method simply delegates to the
 * abstract form, but extra initialisation may go in this method.
 *
 * @author Tony Burdett
 * @date 28-Sep-2009
 */
