...
--------------------------------------------------------
  ...
  CREATE INDEX "IDX_ASSAYONTOLOGY_ASSAY" ON "A2_ASSAYONTOLOGY" ("ASSAYID") /*INDEX_TABLESPACE*/;

  CREATE INDEX "IDX_ASSAYONTOLOGY_ASSAYTERM" ON  "A2_ASSAYONTOLOGY" ("ASSAYID", "ONTOLOGYTERMID") /*INDEX_TABLESPACE*/;
 
  CREATE INDEX "IDX_ASSAYONTOLOGY_TERM" ON "A2_ASSAYONTOLOGY" ("ONTOLOGYTERMID") /*INDEX_TABLESPACE*/;
...
--------------------------------------------------------
  ...
  ALTER TABLE "A2_ASSAYONTOLOGY" ADD CONSTRAINT "FK_ASSAYONTOLOGY_ASSAY" FOREIGN KEY ("ASSAYID") REFERENCES "A2_ASSAY" ("ASSAYID") ENABLE;
  
  ALTER TABLE "A2_ASSAYONTOLOGY" ADD CONSTRAINT "FK_ASSAYONTOLOGY_ONTOLOGY" FOREIGN KEY ("ONTOLOGYTERMID") REFERENCES "A2_ONTOLOGYTERM" ("ONTOLOGYTERMID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "A2_SAMPLEONTOLOGY" ADD CONSTRAINT "FK_SAMPLEONTOLOGY_SAMPLE" FOREIGN KEY ("SAMPLEID") REFERENCES "A2_SAMPLE" ("SAMPLEID") ENABLE;
--------------------------------------------------------
