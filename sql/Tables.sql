...
--------------------------------------------------------
  ...
  CREATE INDEX "A2_IDX_EXPRESSION_FV" ON "A2_EXPRESSIONANALYTICS" ("PROPERTYVALUEID");

--------------------------------------------------------
--  DDL for Index A2_IDX_EXPRESSION_GENE
--------------------------------------------------------

  CREATE INDEX "A2_IDX_EXPRESSION_GENE" ON "A2_EXPRESSIONANALYTICS" ("GENEID");

--------------------------------------------------------
--  DDL for Index IDX_ANALYTICS_DESIGNELEMENT
--------------------------------------------------------

  CREATE INDEX "IDX_ANALYTICS_DESIGNELEMENT" ON "A2_EXPRESSIONANALYTICS" ("DESIGNELEMENTID");
--------------------------------------------------------
--  DDL for Index IDX_ARRAYDESIGN_ACCESSION
--------------------------------------------------------

  CREATE INDEX "IDX_ARRAYDESIGN_ACCESSION" ON "A2_ARRAYDESIGN" ("ACCESSION");

--------------------------------------------------------
--  DDL for Index IDX_ASSAYPROPERTY_AP
--------------------------------------------------------

  CREATE INDEX "IDX_ASSAYPROPERTY_AP" ON "A2_ASSAYPROPERTYVALUE" ("ASSAYID", "PROPERTYVALUEID");

--------------------------------------------------------
--  DDL for Index IDX_ASSAYPROPERTY_ASSAY
--------------------------------------------------------

  CREATE INDEX "IDX_ASSAYPROPERTY_ASSAY" ON "A2_ASSAYPROPERTYVALUE" ("ASSAYID");

--------------------------------------------------------
--  DDL for Index IDX_ASSAYPROPERTY_PEROPERTY
--------------------------------------------------------

  CREATE INDEX "IDX_ASSAYPROPERTY_PEROPERTY" ON "A2_ASSAYPROPERTYVALUE" ("PROPERTYVALUEID");

--------------------------------------------------------
--  DDL for Index IDX_ASSAY_ARRAYDESIGN
--------------------------------------------------------

  CREATE INDEX "IDX_ASSAY_ARRAYDESIGN" ON "A2_ASSAY" ("ARRAYDESIGNID");

--------------------------------------------------------
--  DDL for Index IDX_ASSAY_EXPERIMENT
--------------------------------------------------------

  CREATE INDEX "IDX_ASSAY_EXPERIMENT" ON "A2_ASSAY" ("EXPERIMENTID");

--------------------------------------------------------
--  DDL for Index IDX_DESIGNELEMENT_GENE
--------------------------------------------------------

  CREATE INDEX "IDX_DESIGNELEMENT_GENE" ON "A2_DESIGNELEMENT" ("GENEID");

--------------------------------------------------------
--  DDL for Index IDX_EA_EXPERIMENT
--------------------------------------------------------

  CREATE INDEX "IDX_EA_EXPERIMENT" ON "A2_EXPRESSIONANALYTICS" ("EXPERIMENTID");

--------------------------------------------------------
--  DDL for Index IDX_EV_ASSAYID
--------------------------------------------------------

  CREATE INDEX "IDX_EV_ASSAYID" ON "A2_EXPRESSIONVALUE" ("ASSAYID");

--------------------------------------------------------
--  DDL for Index IDX_EV_DESIGNELEMENT
--------------------------------------------------------

  CREATE INDEX "IDX_EV_DESIGNELEMENT" ON "A2_EXPRESSIONVALUE" ("DESIGNELEMENTID");

--------------------------------------------------------
--  DDL for Index IDX_EXPERIMENT_ACCESSION
--------------------------------------------------------

  CREATE INDEX "IDX_EXPERIMENT_ACCESSION" ON "A2_EXPERIMENT" ("ACCESSION");

--------------------------------------------------------
--  DDL for Index IDX_GENEPROPERTYVALUE_PROPERTY
--------------------------------------------------------

  CREATE INDEX "IDX_GENEPROPERTYVALUE_PROPERTY" ON "A2_GENEPROPERTYVALUE" ("GENEPROPERTYID");

--------------------------------------------------------
--  DDL for Index IDX_GENE_SPEC
--------------------------------------------------------

  CREATE INDEX "IDX_GENE_SPEC" ON "A2_GENE" ("SPECID");

--------------------------------------------------------
--  DDL for Index IDX_GPV_GENE
--------------------------------------------------------

  CREATE INDEX "IDX_GPV_GENE" ON "A2_GENEPROPERTYVALUE" ("GENEID");

--------------------------------------------------------
--  DDL for Index IDX_LOAD_ACCESSION
--------------------------------------------------------

  CREATE INDEX "IDX_LOAD_ACCESSION" ON "LOAD_MONITOR" ("ACCESSION");

--------------------------------------------------------
--  DDL for Index IDX_ONTOLOGYTERM_ONTOLOGY
--------------------------------------------------------

  CREATE INDEX "IDX_ONTOLOGYTERM_ONTOLOGY" ON "A2_ONTOLOGYTERM" ("ONTOLOGYID");

--------------------------------------------------------
--  DDL for Index IDX_PROPERTYVALUE_NAME
--------------------------------------------------------

  CREATE INDEX "IDX_PROPERTYVALUE_NAME" ON "A2_PROPERTYVALUE" ("NAME");

--------------------------------------------------------
--  DDL for Index IDX_PROPERTYVALUE_PROPERTY
--------------------------------------------------------

  CREATE INDEX "IDX_PROPERTYVALUE_PROPERTY" ON "A2_PROPERTYVALUE" ("PROPERTYID");

--------------------------------------------------------
--  DDL for Index IDX_PROPERTY_NAME
--------------------------------------------------------

  CREATE INDEX "IDX_PROPERTY_NAME" ON "A2_PROPERTY" ("NAME");

--------------------------------------------------------
--  DDL for Index IDX_SAMPLEPROPERTY_PROPERTY
--------------------------------------------------------

  CREATE INDEX "IDX_SAMPLEPROPERTY_PROPERTY" ON "A2_SAMPLEPROPERTYVALUE" ("PROPERTYVALUEID");

--------------------------------------------------------
--  DDL for Index IDX_SAMPLEPROPERTY_PS
--------------------------------------------------------

  CREATE INDEX "IDX_SAMPLEPROPERTY_PS" ON "A2_SAMPLEPROPERTYVALUE" ("PROPERTYVALUEID", "SAMPLEID");
...
--------------------------------------------------------
  ...
  CREATE INDEX "IDX_SAMPLEPROPERTY_SAMPLE" ON "A2_SAMPLEPROPERTYVALUE" ("SAMPLEID");

--------------------------------------------------------
--  DDL for Index IDX_SAMPLEPROPERTY_SP
--------------------------------------------------------

  CREATE INDEX "IDX_SAMPLEPROPERTY_SP" ON "A2_SAMPLEPROPERTYVALUE" ("SAMPLEID", "PROPERTYVALUEID");
