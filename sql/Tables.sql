...
--------------------------------------------------------
  ...
  CREATE INDEX "IDX_ANALYTICS_PROPERTY" ON "A2_EXPRESSIONANALYTICS" ("PROPERTYVALUEID") /*INDEX_TABLESPACE*/;
...
--------------------------------------------------------
  ...
  CREATE INDEX "IDX_ASSAYPV_PROPERTYVALUE" ON "A2_ASSAYPV" ("PROPERTYVALUEID") /*INDEX_TABLESPACE*/;

--------------------------------------------------------
--  DDL for Index IDX_ASSAYPROPERTY_ASSAY
--------------------------------------------------------

  CREATE INDEX "IDX_ASSAYPV_ASSAY" ON "A2_ASSAYPV" ("ASSAYID") /*INDEX_TABLESPACE*/;

  CREATE INDEX "IDX_ASSAYPV_AP" ON "A2_ASSAYPV" ("ASSAYID", "PROPERTYVALUEID") /*INDEX_TABLESPACE*/; --composite index
  
  CREATE INDEX "IDX_ASSAYSAMPLE_ASSAY" ON "A2_ASSAYSAMPLE" ("ASSAYID") /*INDEX_TABLESPACE*/;
  
  CREATE INDEX "IDX_ASSAYSAMPLE_SAMPLE" ON "A2_ASSAYSAMPLE" ("SAMPLEID") /*INDEX_TABLESPACE*/;
...
--------------------------------------------------------
  ...
  CREATE INDEX "IDX_DESIGNELEMENT_ARRAYDESIGN" ON "A2_DESIGNELEMENT" ("ARRAYDESIGNID") /*INDEX_TABLESPACE*/;
...
--------------------------------------------------------
  ...
  CREATE INDEX "IDX_SAMPLEPVONTOLOGY_SAMPLEPV" ON "A2_SAMPLEPVONTOLOGY" ("SAMPLEPVID") /*INDEX_TABLESPACE*/;

  CREATE INDEX "IDX_SAMPLEPVONTOLOGY_ONTOLOGY" ON "A2_SAMPLEPVONTOLOGY" ("ONTOLOGYTERMID") /*INDEX_TABLESPACE*/;
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table A2_ASSAYPV commit
--------------------------------------------------------

  ALTER TABLE "A2_ASSAYPV" ADD CONSTRAINT "FK_ASSAYPV_PROPERTY" FOREIGN KEY ("PROPERTYVALUEID") REFERENCES "A2_PROPERTYVALUE" ("PROPERTYVALUEID") ENABLE;
  
  ALTER TABLE "A2_ASSAYPV" ADD CONSTRAINT "FK_ASSAYPV_ASSAY" FOREIGN KEY ("ASSAYID") REFERENCES "A2_ASSAY" ("ASSAYID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "A2_PROPERTYVALUE" ADD CONSTRAINT "FK_PROPERTYVALUE_PROPERTY" FOREIGN KEY ("PROPERTYID") REFERENCES "A2_PROPERTY" ("PROPERTYID") ENABLE;
...
--  ALTER TABLE "A2_DESIGNELEMENT" ADD CONSTRAINT "UQ_DESIGNELEMENT_NAME" UNIQUE("ARRAYDESIGNID","NAME") ENABLE;
  ALTER TABLE "A2_DESIGNELEMENT" ADD CONSTRAINT "UQ_DESIGNELEMENT_ACCESSION" UNIQUE("ARRAYDESIGNID","ACCESSION") ENABLE;
  ALTER TABLE "A2_PROPERTY" ADD CONSTRAINT "UQ_PROPERTY_NAME" UNIQUE("NAME") ENABLE;
  ALTER TABLE "A2_PROPERTYVALUE" ADD CONSTRAINT "UQ_PROPERTYVALUE_NAME" UNIQUE("PROPERTYID","NAME") ENABLE;
  ALTER TABLE "A2_ONTOLOGY" ADD CONSTRAINT "UQ_ONTOLOGY_NAME" UNIQUE("NAME") ENABLE;
  ALTER TABLE "A2_ONTOLOGYTERM" ADD CONSTRAINT "UQ_ONTOLOGYTERM_ACCESSION" UNIQUE(ONTOLOGYID, "ACCESSION") ENABLE;
  ALTER TABLE "A2_ONTOLOGYTERM" ADD CONSTRAINT "UQ_ONTOLOGYTERM_TERM" UNIQUE(ONTOLOGYID, Term) ENABLE;
  ALTER TABLE "A2_ASSAYPV" ADD CONSTRAINT "UQ_ASSAYPV" UNIQUE(ASSAYID, PropertyValueID) ENABLE;  
  ALTER TABLE "A2_ASSAYPVONTOLOGY" ADD CONSTRAINT "UQ_ASSAYPVONTOLOGY" UNIQUE(ONTOLOGYTERMID, ASSAYPVID) ENABLE;
  ALTER TABLE "A2_SAMPLEPV" ADD CONSTRAINT "UQ_SAMPLEPV" UNIQUE(SAMPLEID, PropertyValueID) ENABLE;  
  ALTER TABLE "A2_SAMPLEPVONTOLOGY" ADD CONSTRAINT "UQ_SAMPLEPVONTOLOGY" UNIQUE(ONTOLOGYTERMID, SAMPLEPVID) ENABLE;
  ALTER TABLE "A2_EXPERIMENT" ADD CONSTRAINT "UQ_EXPERIMENT_ACCESSION" UNIQUE("ACCESSION") ENABLE;
  ...
  ALTER TABLE "A2_GENEPROPERTYVALUE" ADD CONSTRAINT "UQ_GENEPROPERTYVALUE_VALUE" UNIQUE("GENEPROPERTYID","VALUE") ENABLE; 
  ALTER TABLE "A2_GENEGPV" ADD CONSTRAINT "UQ_GENEGPV" UNIQUE("GENEID","GENEPROPERTYVALUEID") ENABLE; 
  ALTER TABLE "A2_EXPRESSIONANALYTICS" ADD CONSTRAINT "UQ_ANALYTICS" UNIQUE(ExperimentID,DesignElementID,PropertyValueID) ENABLE; 
...
CREATE TABLE A2_TASKMAN_TASKSTAGELOG
(
  ID INTEGER NOT NULL,
  ...
  TIME TIMESTAMP NOT NULL DEFAULT SYSTIMESTAMP
, CONSTRAINT A2_TASKMAN_TASKSTAGELOG_PK PRIMARY KEY
  (
    ID
  )
)
...
CREATE INDEX A2_TASKMAN_TASKSTAGELOG_IDX1 ON A2_TASKMAN_TASKSTAGELOG (TYPE, ACCESSION) NOPARALLEL;

CREATE SEQUENCE A2_TASKMAN_TASKSTAGELOG_SEQ ;

CREATE
TRIGGER A2_TASKMAN_TASKSTAGELOG_TRG
 BEFORE INSERT ON A2_TASKMAN_TASKSTAGELOG 
FOR EACH ROW 
BEGIN
  SELECT A2_TASKMAN_TASKSTAGELOG_SEQ.NEXTVAL INTO :NEW.ID FROM DUAL;
END;
...
/
  ...
  CREATE TABLE "ATLAS2"."A2_TASKMAN_OPERATIONLOG" 
   (	"ID" NUMBER NOT NULL, 
	"TYPE" VARCHAR2(32) NOT NULL, 
	"ACCESSION" VARCHAR2(128) NOT NULL, 
	"RUNMODE" VARCHAR2(32), 
	...
	"MESSAGE" VARCHAR2(256), 
	"TIME" TIMESTAMP (6) DEFAULT SYSTIMESTAMP NOT NULL, 
	 CONSTRAINT "A2_TASKMAN_OPERATIONLOG_PK" PRIMARY KEY ("ID")
   ) ;
 
  CREATE UNIQUE INDEX "ATLAS2"."A2_TASKMAN_OPERATIONLOG_PK" ON "ATLAS2"."A2_TASKMAN_OPERATIONLOG" ("ID") ;
 
  CREATE INDEX "ATLAS2"."A2_TASKMAN_OPERATIONLOG_IDX1" ON "ATLAS2"."A2_TASKMAN_OPERATIONLOG" ("TYPE", "ACCESSION") ;
 
  CREATE INDEX "ATLAS2"."A2_TASKMAN_OPERATIONLOG_IDX2" ON "ATLAS2"."A2_TASKMAN_OPERATIONLOG" ("USERNAME") ;
 
  CREATE OR REPLACE TRIGGER "ATLAS2"."A2_TASKMAN_OPERATIONLOG_TRG" 
 BEFORE INSERT ON A2_TASKMAN_OPERATIONLOG 
FOR EACH ROW 
BEGIN
  SELECT A2_TASKMAN_OPERATIONLOG_SEQ.NEXTVAL INTO :NEW.ID FROM DUAL;
END;

/

CREATE TABLE A2_TASKMAN_TASKSTAGE
(
  TYPE VARCHAR2(32) NOT NULL,
  ACCESSION VARCHAR2(128) NOT NULL,
  STAGE VARCHAR2(32) NOT NULL
, CONSTRAINT A2_TASKMAN_TASKSTAGE_PK PRIMARY KEY
  (
    TYPE,
    ACCESSION
  )
