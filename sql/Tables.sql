...
/
  ...
  CREATE UNIQUE INDEX "A2_TASKMAN_OPERATIONLOG_PK" ON "ATLAS2"."A2_TASKMAN_OPERATIONLOG" ("ID") /*INDEX_TABLESPACE*/;
 
  CREATE INDEX "A2_TASKMAN_OPERATIONLOG_IDX1" ON "ATLAS2"."A2_TASKMAN_OPERATIONLOG" ("TYPE", "ACCESSION") /*INDEX_TABLESPACE*/;
 
  CREATE INDEX "A2_TASKMAN_OPERATIONLOG_IDX2" ON "ATLAS2"."A2_TASKMAN_OPERATIONLOG" ("USERNAME") /*INDEX_TABLESPACE*/;
