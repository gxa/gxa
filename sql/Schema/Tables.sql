...
/ 
 ...
 CREATE TABLE "A2_DESIGNELEMENT" (
  ...
  , "GENEID" NUMBER(22,0) CONSTRAINT NN_DESIGNELEMENT_GENEID NOT NULL
...
/   
 ...
 ALTER TABLE "A2_ONTOLOGYTERM" 
  ADD CONSTRAINT "UQ_ONTOLOGYTERM_TERM" 
...
-- EXPRESSIONVALUE
--------------------------------------------------------
  CREATE SEQUENCE  "A2_EXPRESSIONVALUE_SEQ" 
    MINVALUE 1 MAXVALUE 1.00000000000000E+27 
    INCREMENT BY 1 START WITH 1 CACHE 20 
    NOORDER  NOCYCLE;
...
/
  ...
  CREATE TABLE "A2_EXPRESSIONVALUE" (
    "EXPRESSIONVALUEID" NUMBER(12,0) CONSTRAINT NN_EXPRESSIONVALUE_ID NOT NULL
  , "VALUE" FLOAT(126) CONSTRAINT NN_EXPRESSIONVALUE_VALUE NOT NULL
  , "DESIGNELEMENTID" NUMBER(12,0) CONSTRAINT NN_EXPRESSIONVALUE_DESIGNELEMENTID NOT NULL
  , "ASSAYID" NUMBER(12,0) CONSTRAINT NN_EXPRESSIONVALUE_ASSAYID NOT NULL);

/

  ALTER TABLE "A2_EXPRESSIONVALUE" 
  ADD CONSTRAINT "PK_EXPRESSIONVALUE" 
    PRIMARY KEY ("EXPRESSIONVALUEID") 
    USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255  
    STORAGE(INITIAL 1048576 
            NEXT 1048576 
            MINEXTENTS 1 
...
/
  ...
  CREATE INDEX "IDX_EV_ASSAYID" 
  ON "A2_EXPRESSIONVALUE" ("ASSAYID") PARALLEL 32 NOLOGGING
  /*INDEX_TABLESPACE*/;
...
/
  ...
  ALTER TABLE "A2_EXPRESSIONVALUE" 
  ADD CONSTRAINT "FK_EXPRESSIONVALUE_ASSAY" 
    FOREIGN KEY ("ASSAYID") 
    REFERENCES "A2_ASSAY" ("ASSAYID") 
    ON DELETE CASCADE
    ENABLE;
...
/
  ...
  ALTER TABLE "A2_EXPRESSIONVALUE" 
  ADD CONSTRAINT "UQ_EXPRESSIONVALUE" 
...
-- EXPRESSIONANALYTICS
--------------------------------------------------------
  CREATE SEQUENCE  "A2_EXPRESSIONANALYTICS_SEQ"  
    MINVALUE 1 MAXVALUE 1.00000000000000E+27 
    INCREMENT BY 1 START WITH 1 CACHE 20 
    NOORDER  NOCYCLE;
...
/    
  ...
  CREATE TABLE "A2_EXPRESSIONANALYTICS" (
    "EXPRESSIONID" NUMBER(22,0) CONSTRAINT NN_EXPRESSIONANALYTICS_ID NOT NULL
  , "EXPERIMENTID" NUMBER(22,0) CONSTRAINT NN_EA_EXPERIMENTID NOT NULL
  , "PROPERTYVALUEID" NUMBER(22,0) CONSTRAINT NN_EA_PROPERTYVALUEID NOT NULL
  , "TSTAT" FLOAT(125)
  , "PVALADJ" FLOAT(125)
  , "FPVAL" FLOAT(125)
  , "FPVALADJ" FLOAT(125)
  , "DESIGNELEMENTID" NUMBER(22,0) CONSTRAINT NN_EA_DESIGNELEMENTID NOT NULL);
...
/    
  ...
  CREATE INDEX "IDX_ANALYTICS_PROPERTY" 
  ON "A2_EXPRESSIONANALYTICS" ("PROPERTYVALUEID") 
  /*INDEX_TABLESPACE*/;

/  

   CREATE INDEX "IDX_ANALYTICS_DESIGNELEMENT" 
  ON "A2_EXPRESSIONANALYTICS" ("DESIGNELEMENTID") 
  /*INDEX_TABLESPACE*/;

/  

  CREATE INDEX "IDX_ANALYTICS_EXPERIMENT" 
  ON "A2_EXPRESSIONANALYTICS" ("EXPERIMENTID") 
  /*INDEX_TABLESPACE*/;
...
(
  ID INTEGER CONSTRAINT NN_TASKSTAGELOG_ID NOT NULL,
  TYPE VARCHAR2(32) CONSTRAINT NN_TASKSTAGELOG_TYPE NOT NULL,
  ACCESSION VARCHAR2(256 CHAR) CONSTRAINT NN_TASKSTAGELOG_ACCESSION NOT NULL,
  STAGE VARCHAR2(32) CONSTRAINT NN_TASKSTAGELOG_STAGE NOT NULL,
  EVENT VARCHAR2(32) CONSTRAINT NN_TASKSTAGELOG_EVENT NOT NULL,
  MESSAGE VARCHAR2(4000 CHAR),
  TIME TIMESTAMP DEFAULT SYSTIMESTAMP CONSTRAINT NN_TASKSTAGELOG_TIME NOT NULL -- NOT NULL DEFAULT SYSTIMESTAMP does not work.
...
CREATE INDEX A2_TASKMAN_TASKSTAGELOG_IDX1 ON A2_TASKMAN_TASKSTAGELOG (TYPE, ACCESSION) NOPARALLEL /*INDEX_TABLESPACE*/;
...
/
  ...
  CREATE TABLE "A2_TASKMAN_OPERATIONLOG" 
   (	"ID" NUMBER CONSTRAINT NN_OPERATIONLOG_ID NOT NULL, 
	"TYPE" VARCHAR2(32) CONSTRAINT NN_OPERATIONLOG_TYPE NOT NULL, 
	"ACCESSION" VARCHAR2(256 CHAR) CONSTRAINT NN_OPERATIONLOG_ACCESSION NOT NULL,
	"RUNMODE" VARCHAR2(32), 
	"USERNAME" VARCHAR2(64) CONSTRAINT NN_OPERATIONLOG_USERNAME NOT NULL, 
	"OPERATION" VARCHAR2(32) CONSTRAINT NN_OPERATIONLOG_OPERATION NOT NULL, 
	"MESSAGE" VARCHAR2(4000 CHAR),
	"TIME" TIMESTAMP (6) DEFAULT SYSTIMESTAMP CONSTRAINT NN_OPERATIONLOG_TIME NOT NULL, 
	 CONSTRAINT "A2_TASKMAN_OPERATIONLOG_PK" PRIMARY KEY ("ID")
   ) ;

/ 

  CREATE UNIQUE INDEX "A2_TASKMAN_OPERATIONLOG_PK" ON "A2_TASKMAN_OPERATIONLOG" ("ID") /*INDEX_TABLESPACE*/;

/ 

  CREATE INDEX "A2_TASKMAN_OPERATIONLOG_IDX1" ON "A2_TASKMAN_OPERATIONLOG" ("TYPE", "ACCESSION") /*INDEX_TABLESPACE*/;

/ 

  CREATE INDEX "A2_TASKMAN_OPERATIONLOG_IDX2" ON "A2_TASKMAN_OPERATIONLOG" ("USERNAME") /*INDEX_TABLESPACE*/;

/

  CREATE SEQUENCE A2_TASKMAN_OPERATIONLOG_SEQ ;

/ 

  CREATE OR REPLACE TRIGGER "A2_TASKMAN_OPERATIONLOG_TRG" 
...
(
  TYPE VARCHAR2(32) CONSTRAINT NN_TASKSTAGE_TYPE NOT NULL,
  ACCESSION VARCHAR2(256 CHAR) CONSTRAINT NN_TASKSTAGE_ACCESSION NOT NULL,
  STAGE VARCHAR2(32) CONSTRAINT NN_TASKSTAGE_STAGE NOT NULL
