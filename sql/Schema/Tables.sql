...
ALTER TABLE A2_BIOMART_ANNSRC
  ADD CONSTRAINT UQ_BMANNSRC_ORGANISM
    UNIQUE(ORGANISMID)
    ENABLE;
...
ALTER TABLE A2_EXTERNAL_BEPROPERTY
  ADD CONSTRAINT FK_EXTPROPERTY_PROPERTY
    FOREIGN KEY (BIOENTITYPROPERTYID)
    REFERENCES A2_BIOENTITYPROPERTY (BIOENTITYPROPERTYID)
    ON DELETE CASCADE
    ENABLE;
...
ALTER TABLE A2_EXTERNAL_BEPROPERTY
  ADD CONSTRAINT FK_EXTPROPERTY_ANNSRC
    FOREIGN KEY (annotationsrcid)
    REFERENCES A2_ANNOTATIONSRC (annotationsrcid)
    ON DELETE CASCADE
    ENABLE;
...
ALTER TABLE A2_EXTERNAL_ARRAYDESIGN
  ADD CONSTRAINT PK_EXTERNAL_ARRAYDESIGN
    PRIMARY KEY (EXTARRAYDESIGNID)
  ENABLE;

ALTER TABLE A2_EXTERNAL_ARRAYDESIGN
  ADD CONSTRAINT FK_EXTERNAL_ARRAYDESIGN_AD
    FOREIGN KEY (ARRAYDESIGNID)
    REFERENCES A2_ARRAYDESIGN (ARRAYDESIGNID)
    ON DELETE CASCADE
    ENABLE;
...
ALTER TABLE A2_EXTERNAL_ARRAYDESIGN
  ADD CONSTRAINT FK_EXTAD_ANNSRC
    FOREIGN KEY (annotationsrcid)
    REFERENCES A2_ANNOTATIONSRC (annotationsrcid)
    ON DELETE CASCADE
    ENABLE;
...
ALTER TABLE A2_EXTERNAL_ARRAYDESIGN
  ADD CONSTRAINT UQ_EXTAD_ANNSRCID_NAME
