...
--------------------------------------------------------
  ...
  , "LEGACY" VARCHAR2(1) default 'F'
  , "VERSION" VARCHAR2(255) CONSTRAINT NN_SOFTWARE_VERSION NOT NULL);
...
CREATE TABLE A2_ANNOTATIONSRC(
  ...
  , LOADDATE DATE
  , annotationsApplied VARCHAR2(1) DEFAULT 'F'
  , mappingsApplied VARCHAR2(1) DEFAULT 'F'
  , isObsolete VARCHAR2(1) DEFAULT 'F'
);
...
CREATE TABLE  A2_BIOMART_ANNSRC(
  ...
  , biomartorganismname VARCHAR2(255) CONSTRAINT NN_BM_ANNSRC_ORGNAME NOT NULL
  , databaseName VARCHAR2(255) CONSTRAINT NN_BM_ANNSRC_DB NOT NULL
  , mySqlDbName VARCHAR2(255) CONSTRAINT NN_BM_ANNSRC_MySQLNAME NOT NULL
  , mySqlDbUrl VARCHAR2(255) CONSTRAINT NN_BM_ANNSRC_MYSQLURL NOT NULL
);
...
CREATE SEQUENCE  A2_EXTERNAL_BEPROPERTY_SEQ
    MINVALUE 1
    INCREMENT BY 1 START WITH 1 CACHE 20
    NOORDER  NOCYCLE;

CREATE TABLE A2_EXTERNAL_BEPROPERTY (
 EXTBEPROPERTYID NUMBER(22,0) CONSTRAINT NN_BMPROPERTY_ID NOT NULL
...
CREATE SEQUENCE  A2_EXTERNAL_ARRAYDESIGN_SEQ
    MINVALUE 1
    INCREMENT BY 1 START WITH 1 CACHE 20
    NOORDER  NOCYCLE;

CREATE TABLE A2_EXTERNAL_ARRAYDESIGN (
 EXTARRAYDESIGNID NUMBER(22,0) CONSTRAINT NN_BMAD_ID NOT NULL
