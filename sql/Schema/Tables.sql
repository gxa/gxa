...
--------------------------------------------------------
  ...
  , "TSTAT" FLOAT(125) NOT NULL
  , "PVALADJ" FLOAT(125) NOT NULL
  , "FPVAL" FLOAT(125)
  , "FPVALADJ" FLOAT(125)
...
--------------------------------------------------------
 ...
 CREATE TABLE "A2_BIOENTITY" (
  ...
  , "TYPE" VARCHAR2(255) CONSTRAINT NN_BIOENTITY_TYPE NOT NULL);
...
--------------------------------------------------------
  ...
  ADD CONSTRAINT "FK_BIOENTITYBEPV_BIOENTITYPV"
    ...
    REFERENCES "A2_BIOENTITYBEPERTYVALUE" ("BEPROPERTYVALUEID")
    ON DELETE CASCADE
    ENABLE;


  ALTER TABLE "A2_BIOENTITYBEPV"
  ADD CONSTRAINT "UQ_BIOENTITYBEPV"
    UNIQUE("BIOENTITYID","BEPROPERTYVALUEID")
    ENABLE;
...
--  MAPPING SOURCE
--------------------------------------------------------
  CREATE SEQUENCE  "A2_MAPPINGSRC_SEQ"
    MINVALUE 1 MAXVALUE 1.00000000000000E+27
    INCREMENT BY 1 START WITH 1 CACHE 20
    NOORDER  NOCYCLE;
  ...
  ADD CONSTRAINT "PK_MAPPINGSRC"
    PRIMARY KEY ("MAPPINGSRCID")
    USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
    STORAGE(INITIAL 1048576
            NEXT 1048576
            MINEXTENTS 1
...
CREATE OR REPLACE TRIGGER "A2_MAPPINGSRC_INSERT"
before insert on A2_MAPPINGSRC
for each row
begin
if(:new.MAPPINGSRCID is null) then
select A2_MAPPINGSRC_seq.nextval into :new.MAPPINGSRCID from dual;
end if;
end;
/

ALTER TRIGGER "A2_MAPPINGSRC_INSERT" ENABLE;
...
--------------------------------------------------------
  ...
  , "MAPPINGSRCID" NUMBER(22,0)  CONSTRAINT NN_DEBE_MAPPINGSRCID NOT NULL);
  ...
  CREATE INDEX "IDX_DEBE_DESIGNELEMENT"
  ON "A2_DESIGNELTBIOENTITY" ("DEBEID")
  /*INDEX_TABLESPACE*/;
  ...
  ADD CONSTRAINT "UQ_DESIGNELTBIOENTITY"
    UNIQUE("BIOENTITYID","DESIGNELEMENTID", "MAPPINGSRCID")
    ENABLE;
