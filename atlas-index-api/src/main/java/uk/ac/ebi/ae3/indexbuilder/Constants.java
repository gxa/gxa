...
public class Constants {
  ...
  /** **/
  public static enum ExperimentSource {
    DW, AE
  }
  ...
  public static final String exptIndexBuilderServiceID =
      "exptIndexBuilderService";
  public static final String geneIndexBuilderServiceID =
      "geneIndexBuilderService";
  ...
  public static final String[] ARRAY_ASSAY_ELEMENTS = {
      EL_type, EL_ba_biometric, EL_ba_cellline, EL_ba_celltype,
      EL_ba_clinhistory,
      EL_ba_clininfo, EL_ba_clintreatment, EL_ba_compound, EL_ba_cultivar,
      EL_ba_devstage,
      EL_ba_diseaseloc, EL_ba_diseasestaging, EL_ba_diseasestate,
      Constants.EL_ba_dose, Constants.EL_ba_ecotype,
      Constants.EL_ba_envhistory, Constants.EL_ba_familyhistory,
      Constants.EL_ba_genmodif, Constants.EL_ba_genotype,
      Constants.EL_ba_histology,
      Constants.EL_ba_indgeneticchar, Constants.EL_ba_individual,
      Constants.EL_ba_light, Constants.EL_ba_media, Constants.EL_ba_observation,
      Constants.EL_ba_organism, Constants.EL_ba_organismpart,
      Constants.EL_ba_organismstatus, Constants.EL_ba_protocoltype,
      Constants.EL_ba_performer, Constants.EL_ba_phenotype,
      Constants.EL_ba_qcdescrtype, Constants.EL_ba_sex,
      Constants.EL_ba_strainorline,
      Constants.EL_ba_targetcelltype, Constants.EL_ba_temperature,
      Constants.EL_ba_testtype, Constants.EL_ba_testresult,
      Constants.EL_ba_test,
      Constants.EL_ba_time, Constants.EL_ba_tumorgrading,
      Constants.EL_ba_vehicle};
  /**
   * Tables contains name of child elements samples*
   */
  public static final String[] ARRAY_SAMPLE_ELEMENTS =
      {Constants.EL_bs_unknown, Constants.EL_BS_AGE, Constants.EL_BS_BIOMETRIC,
       Constants.EL_BS_CELLLINE,
       Constants.EL_BS_CELLTYPE, Constants.EL_BS_CLINHISTORY,
       Constants.EL_BS_CLININFO, Constants.EL_BS_CLINTREATMENT,
       Constants.EL_BS_CULTIVAR, Constants.EL_BS_DEVSTAGE,
       Constants.EL_BS_DISEASELOC, Constants.EL_BS_DISEASESTAGING,
       Constants.EL_BS_DISEASESTATE, Constants.EL_BS_ECOTYPE,
       Constants.EL_BS_ENVHISTORY, Constants.EL_BS_FAMILYHISTORY,
       Constants.EL_BS_GENMODIF, Constants.EL_BS_GENOTYPE,
       Constants.EL_BS_HISTOLOGY, Constants.EL_BS_INDGENETICCHAR,
       Constants.EL_BS_INDIVIDUAL, Constants.EL_BS_INITIALTIME,
       Constants.EL_BS_OBSERVATION, Constants.EL_BS_ORGANISMPART,
       Constants.EL_BS_ORGANISMSTATUS, Constants.EL_BS_PHENOTYPE,
       Constants.EL_BS_SEX, Constants.EL_BS_STRAINORLINE,
       Constants.EL_BS_TARGETCELLTYPE, Constants.EL_BS_TESTRESULT,
       Constants.EL_BS_TESTTYPE, Constants.EL_BS_TEST, EL_BS_TUMORGRADING};
  //exp_accesion fieeld
  ...
  public static final String AT_EXPERIMENT_DESCRIPTION =
  ...
  public static final String FIELD_AER_ARRAYDES_IDENTIFIER =
      "aer_txt_arraydes_identifier";
  ...
  public static final String FIELD_AER_BDG_NUM_BAD_CUBES =
      "aer_bdg_num_bad_cubes";
  public static final String FIELD_AER_BDG_ARRAYDESIGN =
      "aer_txt_bdg_arraydesign";
  public static final String FIELD_AER_BDG_DATAFORMAT = "aer_bdg_dataformat";
  public static final String FIELD_AER_BDG_BIOASSAY_COUNT =
      "aer_bdg_bioassay_count";
  ...
  public static final String FIELD_AER_MIMESCORE_NAME =
      "aer_txt_mimescore_name";
  public static final String FIELD_AER_MIMESCORE_VALUE =
      "aer_txt_mimescore_value";

  public static final String FIELD_AER_BI_ACCESSION = "aer_bi_accession";
  public static final String FIELD_AER_BI_PUBLICATION =
      "aer_txt_bi_publication";
  ...
  public static final String FIELD_AER_PROVIDER_CONTRACT =
      "aer_txt_provider_contact";
  public static final String FIELD_AER_PROVIDER_ROLE = "aer_txt_provider_role";
  public static final String FIELD_AER_PROVIDER_EMAIL =
      "aer_txt_provider_email";
  ...
  public static final String FIELD_AER_FILE_BIOSAMPLEPNG =
      "aer_file_biosamplepng";
  public static final String FIELD_AER_FILE_BIOSAMPLESVG =
      "aer_file_biosamplesvg";
  ...
  public static final String FIELD_DWEXP_ACCESSION =
      PREFIX_DWE + "exp_accession";
  public static final String FIELD_DWEXP_EXPDESC =
      PREFIX_DWE + "exp_description";
