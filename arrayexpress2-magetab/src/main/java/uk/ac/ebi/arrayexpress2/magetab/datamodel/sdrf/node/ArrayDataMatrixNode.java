...
/**
 * An array data matrix node in the graph.  Array Data Matrix nodes are top
 * level nodes and can have associated comments.
 *
 * @author Tony Burdett
 * @date 22-Jan-2009
 */
public class ArrayDataMatrixNode extends AbstractSDRFNode {
  public Map<String, String> comments = new HashMap<String, String>();

  public String[] headers() {
    List<String> headersList = new ArrayList<String>();
    headersList.add("Array Data Matrix File");
