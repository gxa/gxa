...
/**
 * A normalization node in the graph.  Normalization nodes are top level nodes
 * and can have associated sets of comments.
 *
 * @author Tony Burdett
 * @date 22-Jan-2009
 */
public class NormalizationNode extends AbstractSDRFNode {
  public Map<String, String> comments = new HashMap<String, String>();

  public String[] headers() {
    List<String> headersList = new ArrayList<String>();
    headersList.add("Normalization Name");
