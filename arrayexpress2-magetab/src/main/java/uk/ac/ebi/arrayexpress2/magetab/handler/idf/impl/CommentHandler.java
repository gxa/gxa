...
/**
 * A handler that handles all comments in an arrayexpress IDF document,
 * excluding accession comments
 * <p/>
 * Tag: Comment[]
 *
 * @author Tony Burdett
 * @date 09-Mar-2009
 */
public class CommentHandler extends AbstractIDFHandler {
...
//    String[] tokens = line.split("\t", -1);
  ...
  public void readValue(String value) throws ParseException {
    investigation.IDF.addComment(lastType, value);
  }
}
