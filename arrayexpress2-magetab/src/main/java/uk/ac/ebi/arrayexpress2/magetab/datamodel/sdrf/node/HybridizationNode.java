...
/**
 * A hybridization node in the graph.  Hybridization nodes are top level nodes
 * and can have associated comments and factor values.
 *
 * @author Tony Burdett
 * @date 22-Jan-2009
 */
public class HybridizationNode extends AbstractSDRFNode {
  ...
  public List<ArrayDesignNode> arrayDesigns = new ArrayList<ArrayDesignNode>();

  public String[] headers() {
    List<String> headersList = new ArrayList<String>();
    headersList.add("Hybridization Name");
  ...
  /**
   * Delegates to {@link #values(int)} using the channel labeled as channel one.
   * In single channel experiments, this will be all values, but in two or three
   * channel experiments using this form of the method will only return channel
   * one values, resulting in the loss of data.  You should not use this form of
   * the method in multichannel experiments.
   *
