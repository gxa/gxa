...
public class ExperimentWithData implements Closeable {
    ...
    public static final BestDesignElementsResult EMPTY_DESIGN_ELEMENT_RESULT = new BestDesignElementsResult();
    ...
    public BestDesignElementsResult findBestGenesForExperiment(
        ...
        final ExperimentPart expPart = criteria.retrieveFrom(this);
        if (expPart == null)
