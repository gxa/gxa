...
while read error_id; do
      ...
      grep "$error_id" $atlaslog_file | awk '{print $2}' | awk -F, '{print $1}' | xargs -I % grep % $accesslog_file | xargs -I % echo % | awk '{print $1, $4, $7, $9, $11, $12}' | egrep -v ' 200 ' | egrep -v ' 302 '>> $process_file.log
