...
public class GetAssayPropertiesByPropertyValueTest {
    ...
    private static final String QUERY_STRING_WITH_EXACT_MATCH_AND_CASE_INSENSITIVE =
        "select p from Assay t left join t.properties p where upper()";
    ...
    private AssayDAO subject;

    //private AssayDAO subjectSpy;
    ...
    public void initializeSubject() throws Exception {
        ...
        subject = new AssayDAO(sessionFactory);
