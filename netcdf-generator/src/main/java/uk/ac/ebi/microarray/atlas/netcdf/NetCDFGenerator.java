...
public interface NetCDFGenerator<T> {
   ...
   *
   * @throws NetCDFGeneratorException if initialisation of this index builder
   ...
   *
   * @throws NetCDFGeneratorException if shutdown of this index builder failed
   *                                  for any reason
   */
   ...
   * guarantees that the generation of NetCDFs has started.  Implementations are
   * free to define their own multithreaded strategies for NetCDF generation. If
   ...
   * #generateNetCDFs(uk.ac.ebi.microarray.atlas.netcdf.listener.NetCDFGeneratorListener)}.
   * You can also use a listener to get at any errors that may have occurred
   * during NetCDF generation.
   * <p/>
   ...
   *                 generation of the NetCDF repository completes, or when any
   *                 errors occur.
   */
   ...
   * you wish to be notified on completion, you should register a listener to
   * get callback events when the build completes by using {@link
   * #generateNetCDFsForExperiment(String, uk.ac.ebi.microarray.atlas.netcdf.listener.NetCDFGeneratorListener)}.
   * You can also use a listener to get at any errors that may have occurred
   * during NetCDF generation.
   * <p/>
   ...
   *
   * @param experimentAccession the accession of the experiment to generate
   * @param listener            a listener that can be used to supply callbacks
   *                            when generation of the NetCDF for this
