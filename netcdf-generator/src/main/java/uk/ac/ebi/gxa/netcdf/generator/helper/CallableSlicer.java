...
public abstract class CallableSlicer<T> implements Callable<T> {
     ...
     */
    public void setGeneFetchingStrategy(Future<List<Gene>> fetchGenesTask, Set<Gene> unmappedGenes) {
     ...
     */
    public void setAnalyticsFetchingStrategy(Future<List<ExpressionAnalysis>> fetchAnalyticsTask,
