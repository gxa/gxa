 ...
 * constructing the relevant parts of the index for each implementation.  Clients should call {@link #generateNetCDFs()}
 * to trigger NetCDF construction.  At the moment, this method simply delegates to the abstract form, but extra
 * initialisation may go in this method.
 *
 * @author Tony Burdett
 * @date 28-Sep-2009
 */
