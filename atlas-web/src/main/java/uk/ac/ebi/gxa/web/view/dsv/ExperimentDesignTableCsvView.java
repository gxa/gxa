 ...
 */
public class ExperimentDesignTableCsvView extends AbstractCsvView<ExperimentDesignUI.Row> {

    @Override
    protected DsvRowIterator<ExperimentDesignUI.Row> buildDsvDocument(Map<String, Object> model) {
