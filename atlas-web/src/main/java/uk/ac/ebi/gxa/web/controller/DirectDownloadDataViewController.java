...
public class DirectDownloadDataViewController extends AtlasViewController {
    ...
    @Autowired
    public DirectDownloadDataViewController(ExperimentDownloadData experimentDownloadData) {
    ...
    public void directDownloadExperimentExpressions(
        ...
        Collection<? extends DsvDocumentCreator> creators = experimentDownloadData.newDsvCreatorForExpressions(expAcc);
