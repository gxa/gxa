...
import uk.ac.ebi.gxa.utils.dsv.CsvFormat;
...
public abstract class AbstractCsvView<T> extends AbstractDsvView<T> {
     ...
     *
     * @param value if <code>true</code> each value is enclosed with a double quotes
     */
    public void setEnforceDblQuotes(boolean value) {
        format.setEncloseInDblQuotes(value);
    }
