...
<table class="footerpane" id="footerpane" summary="The main footer pane of the page" style="position:fixed; bottom: 0px; z-index:10;">
    <tr>
      <td colspan ="4" class="footerrow">
        <div class="footerdiv" id="footerdiv" style="position:relative">
            <div style="position:absolute;bottom:3px;right:0px;padding:0 10px 0 10px;z-index:20;background:#dedede;">Gene Expression Atlas ${u:getProp('atlas.software.version')} Build <c:out value="${u:getProp('atlas.buildNumber')}"/></div>
