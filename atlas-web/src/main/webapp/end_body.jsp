...
<span style="position:fixed;bottom:6px;right:0px;padding-right:10px;z-index:20;">ArrayExpress Atlas ${u:getProp('atlas.software.version')} Build <c:out value="${u:getProp('atlas.buildNumber')}"/></span>
...
<table class="footerpane" id="footerpane" summary="The main footer pane of the page" style="position:fixed; bottom: 0px">
    <tr>
      <td colspan ="4" class="footerrow">
        <div class="footerdiv" id="footerdiv"  style="z-index:10;">
