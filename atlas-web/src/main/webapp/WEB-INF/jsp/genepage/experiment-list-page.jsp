...
<script type="text/javascript">
    if (ExperimentList) {
        ExperimentList.drawPlots([
            <c:forEach var="exp" varStatus="s" items="${exps}">
            {id: '${exp.id}', acc: '${exp.accession}'}<c:if test="${!s.last}">,</c:if>
            </c:forEach>
        ]);
    }
</script>
                    ...
                    <tr>
                                ...
                                <tr align="left">
                                    <td align="center">
                                        ...
                                        <a title="Show expression profile"
                                           href="${pageContext.request.contextPath}/experiment/${exp.accession}/${atlasGene.urlRewriteEncodedGeneIdentifier}"
                        ...
                        <td>
                            <div style="overflow-y: auto; width:330px; height:150px"
                                 id="${exp.accession}_${atlasGene.geneId}_legend"></div>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
        ...
        <tr>
            <td colspan="3">
                &nbsp;Show <a title="Show expression profile in detail"
                              href="${pageContext.request.contextPath}/experiment/${exp.accession}/${atlasGene.urlRewriteEncodedGeneIdentifier}">expression
                profile</a>
                &nbsp;/&nbsp;
