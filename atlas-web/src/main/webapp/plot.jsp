...
<%
    	...
    	JSONObject options = new JSONObject("{ xaxis:{ticks:0}, yaxis:{ticks:0}, " + 
										  " legend:{show:true, position:\"sw\", container: \"#"+eid+"_"+gid+"_legend\", extContainer: \"#"+eid+"_"+gid+"_legend_ext\", noColumns:1 }," +
										  "	grid:{ backgroundColor: '#fafafa',	autoHighlight: false, hoverable: true, clickable:true, borderWidth: 1}," +
